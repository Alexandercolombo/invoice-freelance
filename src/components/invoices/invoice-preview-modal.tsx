...
export function InvoicePreviewModal({ invoiceId, open, onOpenChange }: InvoicePreviewModalProps) {
  ...
  const validTasks = useMemo(() => {
    ...
    return invoice.tasks.filter((task): task is NonNullable<typeof task> => task !== null);
  }, [invoice?.tasks]);
        ...
        {showSendModal && (
          <SendInvoiceModal
            ...
            onSuccess={() => {
              ...
              toast({
                title: "Ready to send",
                description: "Email content has been copied and invoice PDF is ready to attach.",
                variant: "default",
              });
            }}
          />
